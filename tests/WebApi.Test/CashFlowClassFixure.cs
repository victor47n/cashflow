...
public class CashFlowClassFixure : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _httpClient;

    public CashFlowClassFixure(CustomWebApplicationFactory webApplicationFactory)
    {
